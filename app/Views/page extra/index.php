        ...
        <section class="main-slider style1">
            <div class="slider-box">
                ...
                <div class="banner-carousel owl-theme owl-carousel">
                    <!-- Slide -->
                    <div class="slide">
                        <div class="image-layer" style="background-image:url(<?= site_url() ?>public/assets/images/prem/slide1.jpg)">
                        </div>
                    ...
                    <!-- Slide -->
                    <div class="slide">
                        <div class="image-layer" style="background-image:url(<?= site_url() ?>public/assets/images/prem/slide2.jpg)">
                        </div>
                        <div class="auto-container">
                            <div class="content">
                                <div class="sub-title">
