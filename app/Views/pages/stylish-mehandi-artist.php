                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 order-box-1">
                        <div class="service-details__content">
                            ...
                            <div class="text-box1">
                                <h2>Stylish Mehandi</h2>
                                <p>A stylish mehndi artist is someone who not only has a great skill in creating intricate designs, but also has a sense of creativity and can come up with unique and trendy designs. They keep themselves updated with the latest fashion and style trends and can incorporate them into their mehndi designs.

                                A stylish mehndi artist is not limited to traditional designs, but can also create modern and contemporary designs to cater to the needs of the clients. They use a variety of techniques such as shading, 3D designs, and glitter to make their designs stand out.

                                To find a stylish mehndi artist, you can search online for portfolios and reviews of artists in your area. Look for artists who have a diverse portfolio and are willing to work with you to create a custom design that fits your personal style. You can also ask for recommendations from friends and family who have had good experiences with a particular artist.
                                </p>
                            </div>
                        </div>
                    </div>
