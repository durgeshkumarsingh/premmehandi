                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 order-box-1">
                        <div class="service-details__content">
                            ...
                            <div class="text-box1">
                                <h2>Stylish Mehandi</h2>
                                <p>A henna artist is a skilled individual who specializes in creating intricate designs using henna paste. Henna, also known as mehndi, is a natural dye made from the leaves of the henna plant. It has been used for centuries in various cultures around the world to create temporary body art, particularly for special occasions like weddings, festivals, and celebrations.

A henna artist typically has a strong artistic background and is skilled in creating intricate designs using henna paste. They may work in a variety of settings, including salons, studios, or as freelance artists. Some henna artists specialize in certain styles of henna, such as traditional Indian, Arabic, or Moroccan designs.

To become a henna artist, one must have a thorough understanding of the henna plant and its properties, as well as knowledge of traditional designs and techniques. It takes practice and skill to create a beautiful and intricate henna design, and henna artists often undergo years of training and practice to perfect their craft.

Henna artists are often in high demand, particularly for special occasions like weddings and festivals. They may work with clients to create custom designs, or offer a selection of pre-designed options for clients to choose from. Overall, a henna artist plays an important role in helping individuals celebrate and express themselves through temporary body art.
                                </p>
                            </div>
                        </div>
                    </div>
