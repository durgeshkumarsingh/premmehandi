        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb text-uppercase mb-0">
                    ...
                    <li class="breadcrumb-item"><a class="text-white" href="<?= site_url('services')?>">Bridal mehandi artist</a></li>
    ...
    <div class="container-xxl gallery py-6 pt-4 pb-0">
            <div class="container">
                <div class="text-justify mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    <h1 class="display-6 mb-4">Bridal mehandi artist in <?= $cityn;?></h1>
