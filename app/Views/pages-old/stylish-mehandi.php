 <!--Start breadcrumb area paroller-->
        <section class="breadcrumb-area">
            <div class="breadcrumb-area-bg" style="background-image: url(<?= site_url() ?>assets/images/stylish.jpg);">
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-xl-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-8 col-lg-7 order-box-1">
                        <div class="service-details__content">
                            ...
                            <div class="text-box1">
                                <h2>Stylish Mehandi</h2>
                                <p>The wedding and festival seasons are coming up, and ladies love applying mehandi on every occasion. Stylish Mehandi designs are applied for brides during the marriage or also on sangeet ceremony. They are commonly applied on hands and feet they also applied on full arm and full leg as well. There are different types of mehndi designs for example arabic, indo-arabic, moroccan, traditional, glitter mehandi design and many more.
                                Stylish mehndi designs are related on a lady because of various sort of sentiments. The most well-known one is that the darker the color of mehandi leaves on the hands and feet of a bride, the more she loved, regarded and valued by her husband and mother-in-law in future.
                                </p>
                            </div>
                        </div>
                    </div>
